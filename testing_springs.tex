...
real \vstu;
real \segl;
\strl = 2; %start rigid length
\rbl = 1.0;  %rigid bar length
\enrl = \strl; %end rigid length
...
\draw [line width=4pt] (\c1) -- node[anchor=south] {$l_1$}(\c2) ;
\draw [line width=4pt] (\c3) -- (\c4);
\draw [line width=4pt] (\c5) -- node[anchor=south] {$l_2$}(\c6);
\draw [line width=4pt] (\c7) -- (\c8);
\draw [hspring] (\c3) ++(0,-\rbl*\reor) -- node[anchor=south] {$k_x$}++(\splen,0);
\draw [thick] (\c2) -- ++(\splen/4,0) -- ++(0,\vstu) -- ++(\splen/4,0);
\draw [vspring] (\c2) ++(\splen/4,0) ++(0,\vstu) ++(\splen/4,0) -- node[very near end, left] {$k_y$}++(0,-\vstu*2);
...
\draw [thick](\c4) ++(0,\rbl*\reor) -- node[near end, below] {$k_\theta$}++(\splen/2,0);
\draw [thick](\rssxx,-\rbl*(1-\reor) -- ++(\rstrd,0);
\dofs{-0.2}{-0.2}{0.8}{0.8}{0.1}{100}{310}{0.5}{1'}{2'}{3'}{below}{right}{below};
\dofs{\strl+\splen+\enrl}{0}{0.8}{0.8}{0.1}{100}{310}{0.5}{4'}{5'}{6'}{below}{right}{below};
