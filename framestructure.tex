...
real \piledepth, \pilespace, \pilecoordy, \pilesidespace, \pilespace, \pilecoordy, \pilecoordx, \pilelinethickness;
...
\path[fill=lightgray] (-\leftsoildist,\basewalldepth) -- ++(0,-\leftsoildepth)
...
{\fill[fill=gray]
(\pilecoordx{\pileind}-\pilediameter/2, \pilecoordy) rectangle (\pilecoordx{\pileind}+\pilediameter/2, \pilecoordy-\piledepth);
 \draw[line width=\pilelinethickness](\pilecoordx{\pileind}-\pilediameter/2, \pilecoordy) -- ++(0,-\piledepth);
 \draw[line width=\pilelinethickness](\pilecoordx{\pileind}+\pilediameter/2, \pilecoordy) -- ++(0,-\piledepth);
 \filldraw[line width=\pilelinethickness, fill=white] (\pilecoordx{\pileind}-\pilediameter/4, \pilecoordy-\piledepth)
 ellipse[x radius=\pilediameter/4, y radius=\pilediameter/8];
 \fill[fill=gray] (\pilecoordx{\pileind}, \pilecoordy-\piledepth)
 arc[start angle=180, end angle=360, x radius=\pilediameter/4, y radius=\pilediameter/8];
 \draw[line width=\pilelinethickness] (\pilecoordx{\pileind}, \pilecoordy-\piledepth)
 arc[start angle=180, end angle=360, x radius=\pilediameter/4, y radius=\pilediameter/8];
 }
}{}
